...
public class DefaultPositions {
    protected static final PositionKey POSITION_KAPITAEN = new PositionKey("kapitaen");
    protected static final PositionKey POSITION_STM = new PositionKey("steuermann");
    ...
    protected static final PositionKey POSITION_BACKSCHAFT = new PositionKey("backschaft");
}
