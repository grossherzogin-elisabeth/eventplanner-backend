package org.eventplanner.driven.filesystem.users;
...
public class Crypto {
    ...
    public static @NonNull String encrypt(
    ...
    private static @NonNull String encryptWithSecretKey(@NonNull final String value, @NonNull final SecretKey secretKey) {
        try {
    ...
    private static @NonNull String decryptWithSecretKey(@NonNull final String encrypted, @NonNull final SecretKey secretKey) {
        try {
    ...
    public @NonNull String encrypt(@NonNull final String value) {
        return encryptWithSecretKey(value, secretKey);
    }
